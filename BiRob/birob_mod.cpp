...
void forthLeftThigh()
{
    dJointSetHingeParam(joint[0], dParamFMax, max_force);
    dJointSetHingeParam(joint[0], dParamVel, delta_angle * gain);
}

void holdLeftThigh()
{
    dJointSetHingeParam(joint[0], dParamFMax, max_force);
    dJointSetHingeParam(joint[0], dParamVel, 0.0);
}
...
{
    dJointSetHingeParam(joint[1], dParamFMax, max_force);
    dJointSetHingeParam(joint[1], dParamVel, delta_angle * gain);
}

void holdRightThigh()
{
    dJointSetHingeParam(joint[1], dParamFMax, max_force);
    dJointSetHingeParam(joint[1], dParamVel, 0.0);
}
...
void forthLeftCalf()
{
    dJointSetHingeParam(joint[2], dParamFMax, max_force);
    dJointSetHingeParam(joint[2], dParamVel, delta_angle * gain);
}

void holdLeftCalf()
{
    dJointSetHingeParam(joint[2], dParamFMax, max_force);
    dJointSetHingeParam(joint[2], dParamVel, 0.0);
}
...
void forthRightCalf()
{
    dJointSetHingeParam(joint[3], dParamFMax, max_force);
    dJointSetHingeParam(joint[3], dParamVel, delta_angle * gain);
}

void holdRightCalf()
{
    dJointSetHingeParam(joint[3], dParamFMax, max_force);
    dJointSetHingeParam(joint[3], dParamVel, 0.0);
}
...
void initModel()
{
    ...
    dBodySetPosition(body[0], 0, 0, TORSO_STARTZ);
    ...
    dBodySetPosition(body[1], 0, -0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    ...
    dBodySetPosition(body[2], 0, 0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    TORSO_STARTZ - 0.5 * (TORSO_HEIGHT + THIGH_HEIGHT));
    dMassSetBox(&m, 1, THIGH_LENGTH, THIGH_WIDTH, THIGH_HEIGHT);
    dMassAdjust(&m, THIGH_MASS);
    ...
    dBodySetPosition(body[3], 0, -0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    ...
    dBodySetPosition(body[4], 0, 0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    TORSO_STARTZ - 0.5 * (TORSO_HEIGHT + CALF_HEIGHT) - THIGH_HEIGHT);
    dMassSetBox(&m, 1, CALF_LENGTH, CALF_WIDTH, CALF_HEIGHT);
    dMassAdjust(&m, CALF_MASS);
    ...
    dJointSetHingeAnchor(joint[0], 0, -0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    ...
    dJointSetHingeAnchor(joint[1], 0, 0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    TORSO_STARTZ - 0.5 * TORSO_HEIGHT);
    ...
    dJointSetHingeAnchor(joint[2], 0, -0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    TORSO_STARTZ - 0.5 * TORSO_HEIGHT - THIGH_HEIGHT);
    ...
    dJointSetHingeAnchor(joint[3], 0, 0.5 * (TORSO_WIDTH - THIGH_WIDTH),
    TORSO_STARTZ - 0.5 * TORSO_HEIGHT - THIGH_HEIGHT);
